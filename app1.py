...
from state import current_session
from progress import save_level
from state import current_session
from state import current_session
...
def session_start(username: str):
    start_session()  # FULL RESET
    current_session["levels_completed"] = get_level(username)
...
def session_end(username: str):
    end_session()
    save_level(username, current_session["levels_completed"])
